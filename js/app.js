...
$(function () {
  ...
  setTimeout(() => {
    ...
    chatbotInfo.classList.remove("d-none");
    //HAcemos un fade in
    gsap.fromTo(chatbotInfo, { opacity: 0 }, { opacity: 1, duration: 1 });
  }, 3000);
  // --------------------------------------------- //
  ...
  $("#contact-form").submit(function () {
    ...
    console.log({
      ...
      texto_usuario: $('#contact-form-message').val(),
    });  
    ...
    $.ajax({
      type: "POST",
      url: "https://sendemail-sc3fw4tuaa-uc.a.run.app", //Change
      data: {
        name: $('#contact-form-name').val(),
        email: $('#contact-form-email').val(),
        phone: $('#contact-form-phone').val(),
